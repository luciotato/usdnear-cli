...
class ExtensionAPI extends ContractAPI {
    ...
    set_params(a) {
        ...
        const params={
            collateral_basis_points: 200*PERCENT,
            min_collateral_basis_points: 150*PERCENT,
            borrowing_paused: false,
            min_account_balance: "5"+"0".repeat(24),
            usdnear_apr_basis_points: 2.5*PERCENT,
            epochs_per_year: 365*2,
            operator_fee_basis_points: 50*PERCENT,
            treasury_fee_basis_points: 50*PERCENT,
          }
        
          this._call("set_contract_params",{params:params})
    }

    set_price(a /*:CommandLineArgs*/) /*:void*/{
    
        //--these are some examples on how to consume arguments
        //const price = a.consumeString("to Account")
        //const argumentJson = a.consumeJSON("{ account:userAccount, amount:xxN }")
        
        const priceInYoctos = a.consumeAmount("price","Y")
        
        a.noMoreArgs() // no more positional args should remain
        
        this._call("set_stnear_price_usd",{stnear_price_usd:priceInYoctos})
        
    }
    
    get_account_info(a /*:CommandLineArgs*/) /*:void*/{
    
        //--these are some examples on how to consume arguments
        const accountId = a.consumeString("AccountId")
        //const argumentJson = a.consumeJSON("{ account:userAccount, amount:xxN }")
        //const priceInYoctos = a.consumeAmount("price","Y")
        
        a.noMoreArgs() // no more positional args should remain
        
        this._view("get_account_info",{account_id:accountId})
        
    }

    clear_busy(a /*:CommandLineArgs*/) /*:void*/{
        //--these are some examples on how to consume arguments
        //const price = a.consumeString("to Account")
        //const argumentJson = a.consumeJSON("{ account:userAccount, amount:xxN }")
        //const priceInYoctos = a.consumeAmount("price","Y")
        a.noMoreArgs() // no more positional args should remain
        this._call("clear_busy_flag",{})
    }

    forgive_loan(a /*:CommandLineArgs*/) /*:void*/{
        //--these are some examples on how to consume arguments
        const accountId = a.consumeString("AccountId")
        //const price = a.consumeString("to Account")
        //const argumentJson = a.consumeJSON("{ account:userAccount, amount:xxN }")
        //const priceInYoctos = a.consumeAmount("price","Y")
        a.noMoreArgs() // no more positional args should remain
        this._call("forgive_loan",{account_id:accountId})
    }
